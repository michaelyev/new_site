		...
		<section className="container component-mb relative z-10">
			...
			<ul className="flex inside-mb slider-gap w-full  overflow-x-auto overflow-y-hidden no-scrollbar">
				{perks.map((item) => (
					<li
						key={item.heading}
						className="h-max min-w-[350px] min-h-[175px] text-white font-light border-solid border-[0.5px] border-white py-2 px-4 rounded-2xl "
					>
		...
		<section className="container component-mb relative z-10">
			...
			<ul className="flex inside-mb slider-gap w-full  overflow-x-auto overflow-y-hidden ">
				{perks.map((item) => (
					<li
						key={item.heading}
						className="h-max min-h-[175px] min-w-[350px] text-white font-light border-solid border-[0.5px] border-white py-2 px-4 rounded-2xl cursor-pointer"
					>
						<div className="mb-5 flex items-center">
