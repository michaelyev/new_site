...
export const ServicesHero: React.FC<ServicesHeroProps> = ({
	...
	return (
		<div className="first-component container h-full relative pr-[10px]   sm:pt-[70px] mb-10">
			...
			<div className="flex flex-col gap-10 justify-between lg:flex-row mt-[42px] xl:mt-[100px] lg:mt-[107px] component-mb">
				...
				<div className="lg:ml-[82px] max-xl:mt-[15px] w-full xl:w-1/3] text-white">
					{/* <p className="mb-[15px] text-title">{heroPhrase}</p> */}
					<ReactMarkdown className="markdown-b markdown mb-[30px] text-base max-sm:hidden">
						{heroP}
					</ReactMarkdown>
					<FormMain />
				</div>
