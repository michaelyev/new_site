...
const images = [
	{
		src: "/docs/license.png",
		width: 800,
		height: 600,
		alt: "Construction License",
	},
	{
		src: "/docs/business_license.png",
		width: 800,
		height: 600,
		alt: "Business License",
	},
	{
		src: "/docs/insurance.png",
		width: 800,
		height: 600,
...
const Licensing = () => {
	...
	return (
		<section
			id="licensing"
			className="scroll-anchor container w-full component-mb"
		>
			...
			{isOpen && (
				<Lightbox
					...
					index={currentIndex}
					on={{ closing: () => console.log("Lightbox is closing") }}
				/>
			)}
		</section>
	);
